...
class TestMeasurements(unittest.TestCase):
    def setUp(self) -> None:
        self.measurement = measurements.DescryptiveAnalytics()
...
class TestGeneralPopulation(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.classify = classify.Classify(self.driver, self.project_palestine_users, self.palestine_userbox, self.israel_userbox)
    ...
    def test_export_import(self):
        ...
        ex = export.Export("General Population", self.folderName)
        ex.export_to_json(self.general_population.time_data.to_dict(), "General Population")

        filepath = os.path.join(ex.folder, "General Population.json")
